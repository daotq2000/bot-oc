...
export function BotFormCard({ defaultValues, onSubmit, onCancel, title = 'Create New Bot', submitLabel = 'Create Bot' }: BotFormCardProps) {
    ...
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between gap-4 pb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Configure your bot settings and API credentials</p>
        </div>
        {onCancel && (
          <button
            onClick={onCancel}
